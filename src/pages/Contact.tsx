              ...
              <AnimateOnScroll animation="slide-right" className="order-2 lg:order-2">
                <div className="space-y-8">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <ul className="text-muted-foreground space-y-1 text-sm">
                          <li>Mo - Di: 9:30 - 19:00</li>
                          <li>Do - Sa: 9:30 - 19:00</li>
                          <li>Mittwoch, Sonntag: Geschlossen</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="aspect-video rounded-sm overflow-hidden border border-border mt-8">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d316121.2840307569!2d7.547286756249986!3d51.75685426650775!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47ba3d78f7be1f3f%3A0xd23de4a8cb8daab3!2sHair%20by%20Vanessa!5e0!3m2!1sde!2sde!4v1771612770409!5m2!1sde!2sde"
                      width="100%"
                      height="100%"
